...
disp(['Radial force experienced by bearing A = ', num2str(RadialForce_A), 'N'])
disp(['Radial force experienced by bearing B = ', num2str(RadialForce_B), 'N'])
...
disp(['Required basic dynamic load rating of bearing = ', num2str(C), 'N'])
